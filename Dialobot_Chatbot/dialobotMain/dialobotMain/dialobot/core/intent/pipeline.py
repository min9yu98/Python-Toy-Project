...
from dialobotMain.dialobot.core.utils.const import MODEL_ALIAS
from dialobotMain.dialobot.core.intent.classifier import IntentClassifier
from dialobotMain.dialobot.core.intent.retriever import IntentRetriever
